...
const AddPayment = ({ paymentId, createPayment, updatePayment, onClose }) => {
  ...
  const allPriceTasks = useMemo(() => selectedTasks.length && selectedTasks.reduce((accumulator, currentValue) => accumulator.numberPrice && currentValue.numberPrice && accumulator.numberPrice + currentValue.numberPrice), [selectedTasks])

  const remains = useMemo(() => price && selectedTasks.length && Number(price) - selectedTasks.reduce((accumulator, currentValue) => accumulator.numberPrice && currentValue.numberPrice && accumulator.numberPrice + currentValue.numberPrice
  ), [price, selectedTasks])
