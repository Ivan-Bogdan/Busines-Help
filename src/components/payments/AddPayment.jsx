...
const AddPayment = ({ paymentId, createPayment, updatePayment, onClose }) => {
  ...
  const allPriceTasks = useMemo(() => selectedTasks.length && selectedTasks.reduce((accumulator, currentValue) => console.log(accumulator.numberPrice + currentValue.numberPrice)), [selectedTasks])

  const remains = useMemo(() => price && selectedTasks.length && Number(price) - selectedTasks.reduce((accumulator, currentValue) => console.log(accumulator.numberPrice + currentValue.numberPrice)
  ), [price, selectedTasks])
